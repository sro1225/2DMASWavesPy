...
# =============================================================================
    def _prompt_output_file_path(self):
        #Prompt the user for the dispersion-curve output file name.
        default_name = (
            f"{self.elementdc.site}_"
            f"{self.elementdc.profile}_"
            f"dispersion_curve.txt"
        )

#        return filedialog.asksaveasfilename(
#            initialfile=default_name,
#            title='Save dispersion curve',
...
#        )
    ...
    def save_selection(self):
        ...
        # Write the selected dispersion curve to disk once the user has
        # completed the selection in the GUI.
        self.elementdc.dispersion_curve_file_path = self.elementdc.dispersion_curve_file_path or None
        self.elementdc.save_dispersion_curve()
        ...
        output_path = self._prompt_output_file_path()
        if not output_path:
            self.message_to_user('No output file was selected; the dispersion curve was not written to disk. \n \n \n \n')
            return

        #self.elementdc.dispersion_curve_file_path = output_path
        #self.elementdc.save_dispersion_curve(output_path)
